    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('user_type', models.CharField(choices=[('CUS', 'Customer'), ('EMP', 'Employee'), ('ADM', 'Administrator')], default='CUS', max_length=3)),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('timezone', models.CharField(choices=user_accounts.models.get_timezone_choices, default='UTC', max_length=50, verbose_name='Timezone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reports_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subordinates', to='user_accounts.employee', verbose_name='Reports To')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='territories', to='user_accounts.region', verbose_name='Region')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_territories', to='user_accounts.employee', verbose_name='Employee')),
                ('territory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='territory_employees', to='user_accounts.territory', verbose_name='Territory')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='territories',
            field=models.ManyToManyField(related_name='employees', through='user_accounts.EmployeeTerritory', to='user_accounts.territory', verbose_name='Territories'),
        ),
        migrations.AddIndex(
            model_name='northwinduser',
            index=models.Index(fields=['last_name', 'first_name'], name='user_accoun_last_na_50b07f_idx'),
        ),
        migrations.AddIndex(
            model_name='customercontact',
            index=models.Index(fields=['city', 'country'], name='user_accoun_city_ceff51_idx'),
        ),
        migrations.AddIndex(
            model_name='employeeterritory',
            index=models.Index(fields=['employee', 'territory'], name='user_accoun_employe_094784_idx'),
        ),
